...
const RULES = [
  ...
  {
    title: "⏰ 장 시간",
    body: "매일 정해진 시간에 장이 열리고, 주가는 5분마다 움직입니다. 장 시간과 휴장일은 매장 사정에 따라 바뀔 수 있어요 (시세판 하단 안내 참고).",
  },
  {
    title: "시작 자금과 방문 보너스",
  ...
  {
    title: "매매 규칙",
    body: "주문은 시장가만 가능하고, 현재 표시 가격으로 즉시 체결됩니다. 매도할 때만 수수료 0.5%가 빠져나갑니다. 하루 등락폭은 전일 종가의 ±30%로 제한됩니다.",
  },
  {
    title: "뉴스 읽는 법",
  ...
  {
    title: "순위와 상품",
    body: "순위는 총자산(현금+보유 주식 평가액) 기준입니다. 최종 순위는 8월 30일(일) 장 마감 종가로 확정되며, 결과는 매장에서 발표됩니다. 부정행위(다계정 등)가 적발되면 계정이 정지됩니다.",
  },
];

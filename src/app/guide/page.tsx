...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "매도할 때만 수수료 1.5%가 빠집니다. 매수 수수료는 없어요.",
  ...
  },
  {
    ...
    title: "뉴스와 소문 읽기",
    body: [
      "뉴스는 종류마다 믿을 만한 정도가 달라요. 공시는 이미 일어난 일의 발표라 확실하고, 정식 뉴스는 대체로 맞지만 가끔 틀려요.",
      "찌라시는 근거 없는 소문이에요. 절반쯤만 맞으니 곧이곧대로 믿지 마세요.",
      "장 초반에 뜨는 종목 뉴스는 방향을 콕 집어주지 않고 분위기만 흘려요. 진짜 호재인지, 잠깐 띄웠다 꺼지는 미끼인지는 직접 시세와 거래량으로 확인해야 해요.",
      "거래량은 좋은 힌트예요. 값이 오르면서 거래량도 함께 실리면 진짜일 가능성이 높고, 조용히 슬금슬금 오르면 조심하는 게 좋아요. 다만 늘 맞는 규칙은 아니에요.",
    ],
  },
  {
    icon: TimerIcon,

...
const RULES = [
  ...
  {
    title: "⏰ 장 시간",
    body: "수~일 15:00 ~ 22:00에 장이 열립니다. 나라카 휴무일(월·화)은 휴장이며, 주가는 5분마다 움직입니다.",
  },
  {
    title: "💰 시작 자금과 방문 보너스",
  ...
  {
    title: "💸 배당",
    body: "안정주(나라카전자·나라카증권)를 들고 있으면 매주 금요일 장 마감 때 보유 평가액의 1%가 현금으로 들어옵니다.",
  },
  {
    title: "⚡ 거래 정지",
  ...
  {
    title: "🏆 순위와 상품",
    body: "순위는 총자산(현금+보유 주식 평가액) 기준이며 랭킹 탭에서 실시간 확인할 수 있습니다. 최종 순위는 8월 30일(일) 22:00 종가로 확정됩니다. 부정행위(다계정 등)가 적발되면 계정이 정지됩니다.",
  },
];

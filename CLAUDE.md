...
- 장 시간: 매일 개장(정기 휴장 없음 — 휴장일은 추후 논의 시 config로 지정), 장 시간은 어드민 설정값(`config`) / 상하한: 직전 개장일 종가 ±30% / 시장가 주문만 / 매도 수수료 1.5%(단타 회전 억제 — 실력자 우승 밸런스, 2026-07-20, `config.sell_fee_bp=150`)
